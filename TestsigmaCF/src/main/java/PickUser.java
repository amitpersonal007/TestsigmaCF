...
public class PickUser extends TestsigmaCustomFunctions{
    @CustomTestStep
    public TestStepResult MapApi(String envvariable, String runtimevar) throws IOException {
        ...
        try {
            ...
            String nospecialchardata = removeSpecialCharacters(result1);
            System.out.println("Result: " + result);

            // System.out.println("Strings without Timestamp: " + result1);
            if(nospecialchardata.isEmpty()){
               ...
               // System.out.println("Random User details: " + randomEmail);
                ...
                result.setStatus(ResultConstants.SUCCESS);
                result.setMessage("Picking a random user from fresh list,Since fresh users are available "+randomEmail+"  And updating the user with time stamp"+new1);
            }
